                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p><b>No KTP :</b> {{ $p->user->guest->no_ktp }}</p>
                                                <p><b>Nama :</b> {{ $p->user->name }}</p>
                                                <p><b>No Telp :</b> {{ $p->user->guest->telp }}</p>
                                                <p><b>Email :</b> {{ $p->user->email }}</p>
                                                <p><b>Alamat :</b> {{ $p->user->guest->alamat }}</p>

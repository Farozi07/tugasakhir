...
(function (f) {
    ...
    f.extend(w.prototype, {
        ...
        _constructor: function () {
            ...
            f("body").on("keyup." + this.s.namespace, function (g) {
                if (!z.activeElement || z.activeElement === z.body) {
                    ...
                    -1 !== a.s.listenKeys.toLowerCase().indexOf(m) &&
                        a._keypress(m, g);
                }
            });
        },
        ...
        _expandButton: function (a, b, c, d, h, e, g) {
            ...
            for (var r = t.length; c < r; c++) {
                ...
                if (n)
                    if (
                        ((b = n.config !== q && n.config.split ? !0 : !1),
                        Array.isArray(n))
                    )
                        this._expandButton(
                            a,
                        ...
                        if (l) {
                            ...
                            l.conf.parent = g;
                            n.init &&
                                n.init.call(m.button(l.node), m, f(l.node), n);
                            k++;
                        }
                    }
            }
        ...
        _resolveExtends: function (a) {
            var b = this,
                ...
                h = function (k) {
                    for (
                        var t = 0;
                        !f.isPlainObject(k) && !Array.isArray(k);
            ...
            var c = [],
                ...
                h = function (m, k) {
                    ...
                    if (Array.isArray(m) || m instanceof f)
                        ...
                        k.s.buttons[m] &&
                            c.push({ inst: k, node: k.s.buttons[m].node });
                    else if ("string" === typeof m)
                        if (-1 !== m.indexOf(","))
                            for (
                                r = m.split(","), n = 0, t = r.length;
                                n < t;
                                n++
                            )
                                h(r[n].trim(), k);
                            ...
                            for (
                                m = m.replace(":name", ""), n = 0, t = r.length;
                                n < t;
                                n++
                            )
                                r[n].name === m &&
    ...
    f.extend(A, {
        ...
        excel: function (a, b) {
            if (A.excelHtml5 && A.excelHtml5.available(a, b))
                return "excelHtml5";
        },
        pdf: function (a, b) {
